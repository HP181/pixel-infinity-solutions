        ...
        <div className="  px-5 py-14 mx-auto">
          <div className=" flex flex-col text-center  w-full mb-20">
            ...
            <p className=" mt-4 text-justify sm:text-center sm:pt-4 lg:w-2/3 mx-auto leading-relaxed text-base">
              Pixel Infinity Solutions is a well established IT company in Canada. we offer
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full lg:w-1/2 xl:w-1/4 px-8 py-6 border-gray-200 border-opacity-60 lg:border-l-2">
              ...
              <p className="leading-relaxed text-base mb-4 text-justify sm:text-center">
                Pixel Infinity Solutions provide unique desging with fully responsive websites.
              </p>
            </div>
          </div>
        </div>
